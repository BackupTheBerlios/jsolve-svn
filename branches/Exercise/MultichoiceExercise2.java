 ...
 */
public class MultichoiceExercise2 extends Exercise {
 ...
 */
    ...
    private MultiCreateAnswerPanel createPanel;
   // private MultiAnswerPanel solvePanel;
 ...
 *
 **/
    public MultichoiceExercise2(){
        super("","","");
        createPanel = new MultiCreateAnswerPanel();
        //solvePanel = new MultiAnswerPanel();
    }
    
    public MultichoiceExercise2(String title, String theme, String question, List<String> possibilities, int correctSolution)
    {
 ...
 */
    public List<String> getPossibilities() {
        ...
        return createPanel.getPosibilities();
    }
 ...
 */
    public int getCorrectSolution() {
    	return createPanel.getJuisteKeuze();
    }
    
    public MultiCreateAnswerPanel getCreateAnswerPanel(){
        return createPanel;
    }
