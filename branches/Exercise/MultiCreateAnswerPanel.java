/*
 * MultiCreateAnswerPanel.java
 *
 * Created on 16 mei 2006, 22:10
 */
 ...
 */
public class MultiCreateAnswerPanel extends javax.swing.JPanel {
    
    /** Creates new form MultiCreateAnswerPanel */
    public MultiCreateAnswerPanel() {
        initComponents();
    }
    
    public List<String> getPosibilities(){
        List<String> keuzes = new ArrayList<String>();
        keuzes.add(jTextField1.getText());
        keuzes.add(jTextField2.getText());
        keuzes.add(jTextField3.getText());
        keuzes.add(jTextField4.getText());
        return keuzes;
    }
    
    /*
     * geeft juiste antwoord weer, beginnend van 1 !
     */
    public int getJuisteKeuze(){
//        Enumeration<JRadioButton> enumer = (Enumeration<JRadioButton>)buttonGroup1.getElements();
//        int juist = 0;
//        boolean stop = false;
//        while (enumer.hasMoreElements() && !stop){
//            JRadioButton button = enumer.nextElement();
